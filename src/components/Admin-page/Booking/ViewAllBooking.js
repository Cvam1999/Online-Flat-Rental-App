...
function ViewAllBooking() {
    ...
    useEffect(() => {
        const URL = 'http://localhost:9093/FlatBookingCtrl/viewAllFlatBooking';
      ...
      <React.Fragment>
        <table class="table table-data table-striped table-bordered">
                ...
                bookings.map (
                    ...
                    <td class="col-md-1">{booking.flat.flatId}</td>
                    <td class="col-md-1">{booking.tenantId.tenantId}</td>
